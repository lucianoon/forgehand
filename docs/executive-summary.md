...
| Composição e serviço | `app/api/container.py` | Importa e reúne referências a agentes, workflow, infraestrutura e providers; declara `WorkflowService` como fronteira HTTP-grafo. | `E8` |
